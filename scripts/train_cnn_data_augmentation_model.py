...
def train_models(IMG_SIZE, NUM_EPOCHS):
    ...
    model_1.fit_generator(datagen.flow(X_train_fit, y_train_fit_sparse,
                                       ...
                                       epochs=NUM_EPOCHS, validation_data=(X_val, y_val_sparse))
    ...
    file_name_1 = "CNN_" + str(len(model_1.layers)) + "_layers_number_images_" + str(len(X)) + "_image_size_" + str(IMG_SIZE) + "_data_augmentation_metrics.txt"
    ...
    model_2.fit_generator(datagen.flow(X_train_fit, y_train_fit_sparse,
                                       batch_size=128), steps_per_epoch=len(X_train_fit),
                                       epochs=NUM_EPOCHS, validation_data=(X_val, y_val_sparse))
    ...
    file_name_2 = "CNN_" + str(len(model_2.layers)) + "_layers_number_images_" + str(len(X)) + "_image_size_" + str(IMG_SIZE) + "_data_augmentation_metrics.txt"
...
# example usage: $python train_cnn_data_augmentation_model.py 25 50 => image size is 25 and 50 epochs.
